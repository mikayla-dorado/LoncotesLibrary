...
public class LoncotesLibraryDbContext : DbContext
{
    ...
    {
        new Material {Id = 1, MaterialName = "The Bodyguard", MaterialTypeId = 1, GenreId = 1, OutofCirculationSince = null},
    ...
    modelBuilder.Entity<MaterialType>().HasData(new MaterialType []
    {
        ...
        new MaterialType {Id = 3, Name = "CD", CheckoutDays = 0}
    });

    modelBuilder.Entity<Patron>().HasData(new Patron []
    {
        new Patron {Id = 1, FirstName = "Ely", LastName = "Dorado", Address = "123 Ct Rd", IsActive = false},
        new Patron {Id = 2, FirstName = "Amanda", LastName = "Dorado", Address = "123 Ct Rd", IsActive = true},
        new Patron {Id = 3, FirstName = "Zeke", LastName = "Dorado", Address = "123 Ct Rd", IsActive = true},
    });
